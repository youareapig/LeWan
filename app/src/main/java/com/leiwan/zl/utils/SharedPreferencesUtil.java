...
public class SharedPreferencesUtil {
    ...
    public static final String mTAG = "lewan";
    //   创建一个写入器
    ...
    public void putSP(String key, int value) {
    ...
    public int getSP(String key,int defalt) {
        return mPreferences.getInt(key, defalt);
    }
