...
import com.leiwan.zl.details.MyTabAdapter;
...
public class DragScrollLayout extends LinearLayout {
    ...
    private boolean canViewPagerScrollVertically(ViewPager viewPager, int offset, MotionEvent ev) {
        ...
        if(viewPager.getAdapter() instanceof MyTabAdapter){
            View showView = ((MyTabAdapter) viewPager.getAdapter()).getPrimaryItem();
